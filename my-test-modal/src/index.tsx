...
const classes = {
  root: 'my-test-modal-root',
  overlay: 'my-test-modal-overlay',
  overlayAnimationIn: 'my-test-modal-overlay-in',
  overlayAnimationOut: 'my-test-modal-overlay-out',
  modalContainer: 'my-test-modal-container',
  modalContainerCenter: 'my-test-modal-containerCenter',
  modal: 'my-test-modal-modal',
  modalAnimationIn: 'my-test-modal-modal-in',
  modalAnimationOut: 'my-test-modal-modal-out',
  closeButton: 'my-test-modal-closeButton',
};
