...
- Typescript support
- [Small bundle size](https://bundlephobia.com/result?p=my-test-modal)

## Installation

Inside your project directory, install my-test-modal by running the following:

```sh
npm install my-test-modal --save
# Or with yarn
yarn add my-test-modal
```

## Usage

[![Edit my-test-modal](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/9jxp669j2o)
...
💡 When you integrate my-test-modal in your app, make sure that your Modal content is wrapped in an element so the close icon is not shown on top.
...
my-test-modal is licensed under the [MIT license](https://U4EA22@bitbucket.org/U4EA22/my-test-modal/blob/master/LICENSE).
